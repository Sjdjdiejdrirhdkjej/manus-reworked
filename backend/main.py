    ...
    try:
        ...
        if message.mode == "chat":
            ...
            if not MCP_SERVER_URL:
                raise HTTPException(status_code=500, detail="MCP_SERVER_URL environment variable is not set. Please configure it.")
            model_tools = [
                {
                    "type": "function",
                    "function": {
